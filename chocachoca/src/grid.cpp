...
// template<typename T> float Grid<T>::addStep(float x, float z)
// {
...
template<typename T> typename Grid<T>::Key Grid<T>::pointToGrid(const std::pair<int,int> &p) const
{
